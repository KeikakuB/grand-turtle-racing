...
namespace PM3D
{
  namespace meta
  {
    REGISTER_COMPONENT_CPP_ID(MeshRenderComponent);
    template<>
    component_interface_id_list_t GetComponentInterfaces<MeshRenderComponent>() noexcept { return{ GetInterfaceId<IRenderComponentInterface>() }; }
  }
  // Definir l'organisation de notre sommet
  std::array<D3D11_INPUT_ELEMENT_DESC, 3> MeshRenderComponent::MeshVertex::layout =
  {
  ...
  MeshRenderComponent::MeshRenderComponent(const std::string& id)
  ...
  void MeshRenderComponent::InitEffet()
  {
  ...
  void MeshRenderComponent::TransfertObjet(IChargeur& chargeur)
  {
  ...
  void MeshRenderComponent::Draw() const
  {
    // Obtenir le contexte
  ...
  bool MeshRenderComponent::CanOptimizeLod() const
  {
