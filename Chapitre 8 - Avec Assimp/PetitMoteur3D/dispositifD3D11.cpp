...
namespace PM3D
{
  CDispositifD3D11::~CDispositifD3D11()
  {
    ...
    DXRelacher(mSolidCullFrontRS);
    DXRelacher(mSolidCullNoneRS);
    DXRelacher(pDepthTexture);
    DXRelacher(pDepthStencilView);
    DXRelacher(mZBufferActif);
    DXRelacher(mZBufferInactif);
    ...
    const HWND hWnd)
  {
    ...
    rsDesc.FrontCounterClockwise = false;
    pD3DDevice->CreateRasterizerState(&rsDesc, &mSolidCullFrontRS);
  ...
  void CDispositifD3D11::InitDepthBuffer()
  {
    ...
    depthTextureDesc.Width = static_cast<unsigned int>( largeurEcran );
    depthTextureDesc.Height = static_cast<unsigned int>( hauteurEcran );
  ...
  void CDispositifD3D11::ActivateZBuffer()
  {
    pImmediateContext->OMSetDepthStencilState(mZBufferActif, 0);
  }

  void CDispositifD3D11::DeactivateZBuffer()
  {
    pImmediateContext->OMSetDepthStencilState(mZBufferInactif, 0);
  }
  void CDispositifD3D11::ActivateBackCulling()
  {
    pImmediateContext->RSSetState(mSolidCullBackRS);
  }

  void CDispositifD3D11::ActivateFrontCulling()
  {
    pImmediateContext->RSSetState(mSolidCullFrontRS);
  }

  void CDispositifD3D11::DeactivateCulling()
  {
